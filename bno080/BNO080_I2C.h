...
class BNO080
{
  public:
	...
	bool begin(uint8_t deviceAddress = BNO080_DEFAULT_ADDRESS); //By default use the default I2C addres, and use Wire port, and don't declare an INT pin
  ...
  private:
	//Variables
	int     _i2cfh;		//The generic connection to user's chosen I2C hardware
